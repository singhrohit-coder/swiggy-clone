...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="res-card bg-yellow-200 border border-black-500 p-2 m-3 rounded-lg shadow-md w-56 hover:shadow-lg transition-transform duration-300 hover:scale-95">
      <img
